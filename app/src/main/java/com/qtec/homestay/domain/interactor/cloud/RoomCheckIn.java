 ...
 * @date 15-9-9
 */
public class RoomCheckIn extends UseCase<CheckInRoomResponse> {

  private final CloudRepository cloudRepository;

  @Inject public RoomCheckIn(CloudRepository cloudRepository, ThreadExecutor threadExecutor,
  ...
  @Override
  protected Observable<CheckInRoomResponse> buildUseCaseObservable(IRequest param) {
    return cloudRepository.checkInRoom(param);
  }
}
