 ...
 * @date 15-9-9
 */
public class SelectRoomList extends UseCase<List<SelectRoomResponse>> {

  private final CloudRepository cloudRepository;

  @Inject public SelectRoomList(CloudRepository cloudRepository, ThreadExecutor threadExecutor,
  ...
  @Override
  protected Observable<List<SelectRoomResponse>> buildUseCaseObservable(IRequest param) {
    return cloudRepository.selectRoomList(param);
  }
}
