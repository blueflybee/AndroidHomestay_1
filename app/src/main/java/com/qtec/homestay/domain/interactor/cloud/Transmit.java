 ...
 * </pre>
 */
public class Transmit extends UseCase<TransmitResponse> {

  private final CloudRepository cloudRepository;

  @Inject public Transmit(CloudRepository cloudRepository, ThreadExecutor threadExecutor,
  ...
  @Override
  protected Observable<TransmitResponse> buildUseCaseObservable(IRequest request) {
    return cloudRepository.transmit(request);
  }
}