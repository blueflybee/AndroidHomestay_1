...
import com.qtec.homestay.databinding.FragmentAllUnlockRecordsBinding;
 ...
 *     e-mail :
 *     time   : 2018/08/13
 *     desc   : AllUnlockRecordsFragment
 * </pre>
 */
public class AllUnlockRecordsFragment extends BaseFragment implements DeviceRecordView {

  private static final String TAG = AllUnlockRecordsFragment.class.getName();

  @Inject
  DeviceRecordPresenter mDeviceRecordsPresenter;

  private FragmentAllUnlockRecordsBinding mBinding;
  private LockRecordListAdapter mAdapter;

  private String mLimit = "-1";

  public static AllUnlockRecordsFragment newInstance() {
    Bundle args = new Bundle();
    AllUnlockRecordsFragment fragment = new AllUnlockRecordsFragment();
  ...
  public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
    mBinding = DataBindingUtil.inflate(inflater, R.layout.fragment_all_unlock_records, container, false);
